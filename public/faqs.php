...
<head>
  ...
  <style>
    ...
    .faqs-hero h1 { font-size: 2.2rem; font-weight: 700; margin-bottom: 8px; }
    .faqs-hero p  { opacity: .85; font-size: 1.05rem; max-width: 520px; margin: 0 auto 28px; }

    /* Search */
    .faq-search-wrap { max-width: 480px; margin: 0 auto; position: relative; }
    .faq-search-wrap input {
      border-radius: 50px; border: none; padding: 11px 46px 11px 20px;
      width: 100%; font-size: .95rem;
      box-shadow: 0 2px 12px rgba(0,0,0,.18);
    }
    .faq-search-wrap .bi-search {
      position: absolute; right: 16px; top: 50%; transform: translateY(-50%);
      color: var(--qc-green); font-size: 1rem;
    }

    /* Tab pills */
    .faq-tabs { background: #fff; border-bottom: 1px solid #e0e5e0; padding: 14px 0; }
    .faq-tab {
      display: inline-block; padding: 6px 20px;
      border: 1.5px solid #cdd8cd; border-radius: 50px;
      font-size: .87rem; cursor: pointer; margin: 4px; color: #444;
      transition: all .2s;
    }
    ...
    .faq-group-title {
      font-size: 1rem; font-weight: 700; color: var(--qc-green);
      text-transform: uppercase; letter-spacing: .06em;
      margin: 32px 0 12px; padding-bottom: 6px;
      border-bottom: 2px solid var(--qc-green-light);
    }

    .accordion-button { font-weight: 600; font-size: .96rem; color: #1a2e1a; }
    .accordion-button:not(.collapsed) { background: var(--qc-green-light); color: var(--qc-green); }
    .accordion-button:focus { box-shadow: 0 0 0 .2rem rgba(0,93,33,.2); }
    .accordion-item { border: 1px solid #dee2de; border-radius: 10px !important; margin-bottom: 10px; overflow: hidden; }
    .accordion-body { font-size: .93rem; color: #444; line-height: 1.7; }

    /* CTA banner */
    .faq-cta {
      background: var(--qc-green-light); border-radius: 14px;
      padding: 32px; text-align: center; margin-top: 40px;
    }
    .faq-cta h5 { font-weight: 700; color: #1a2e1a; margin-bottom: 8px; }
    .faq-cta p  { color: #555; margin-bottom: 18px; }
    .btn-qc { background: var(--qc-green); color: #fff; border-radius: 8px; padding: 9px 26px; border: none; font-weight: 600; }
    .btn-qc:hover { background: #004819; color: #fff; }
        ...
        <div class="accordion-item faq-item" data-group="orders">
          ...
          <div id="faq-o1" class="accordion-collapse collapse">
            <div class="accordion-body">
              Browse our products, add items to your cart, and proceed to checkout. You'll need to be logged in to complete your purchase. If you don't have an account yet, <a href="/WST-QuickCart/public/registration.php" style="color:var(--qc-green);">register here</a> — it only takes a minute!
            </div>
          </div>
        </div>
        <div class="accordion-item faq-item" data-group="orders">
          ...
          <div id="faq-o2" class="accordion-collapse collapse">
            <div class="accordion-body">
              You may cancel or modify your order within <strong>1 hour</strong> of placing it, provided it hasn't been processed yet. Go to <em>My Account → Orders</em> and select the order to make changes. After processing, cancellation is no longer available.
            </div>
          </div>
        </div>
        <div class="accordion-item faq-item" data-group="orders">
          ...
          <div id="faq-o3" class="accordion-collapse collapse">
            <div class="accordion-body">
              Once your order is shipped, you'll receive an email with a tracking number. You can also check the status in <em>My Account → Orders</em> at any time.
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="accordion" id="accordionShipping">
        <div class="accordion-item faq-item" data-group="shipping">
          ...
          <div id="faq-s1" class="accordion-collapse collapse">
            <div class="accordion-body">
              We offer Standard Shipping (3–7 business days), Express Shipping (1–2 business days), and same-day delivery in select areas. Shipping fees are calculated at checkout based on your location and chosen method.
            </div>
          </div>
        </div>
        <div class="accordion-item faq-item" data-group="shipping">
          ...
          <div id="faq-s2" class="accordion-collapse collapse">
            <div class="accordion-body">
              Yes! Orders above <strong>₱1,500</strong> qualify for free standard shipping within the Philippines. Look out for special promotions that may lower this threshold.
            </div>
          </div>
        </div>
        <div class="accordion-item faq-item" data-group="shipping">
          ...
          <div id="faq-s3" class="accordion-collapse collapse">
            <div class="accordion-body">
              Currently, QuickCart ships within the Philippines only. International shipping is on our roadmap — stay tuned for announcements!
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="accordion" id="accordionPayment">
        <div class="accordion-item faq-item" data-group="payment">
          ...
          <div id="faq-p1" class="accordion-collapse collapse">
            <div class="accordion-body">
              We accept GCash, Maya, credit/debit cards (Visa, Mastercard), and Cash on Delivery (COD) for eligible areas.
            </div>
          </div>
        </div>
        <div class="accordion-item faq-item" data-group="payment">
          ...
          <div id="faq-p2" class="accordion-collapse collapse">
            <div class="accordion-body">
              Absolutely. All transactions are encrypted using SSL/TLS. We do not store your card details on our servers. Payments are processed through certified, PCI-compliant gateways.
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="accordion" id="accordionAccount">
        <div class="accordion-item faq-item" data-group="account">
          ...
          <div id="faq-a1" class="accordion-collapse collapse">
            <div class="accordion-body">
              Click <a href="/WST-QuickCart/public/registration.php" style="color:var(--qc-green);">Register</a> and fill in your details. Registration is free and takes less than a minute.
            </div>
          </div>
        </div>
        <div class="accordion-item faq-item" data-group="account">
          ...
          <div id="faq-a2" class="accordion-collapse collapse">
            <div class="accordion-body">
              On the login page, click <em>"Forgot Password?"</em> and enter your registered email. You'll receive a reset link within a few minutes.
            </div>
          </div>
        </div>
        <div class="accordion-item faq-item" data-group="account">
          ...
          <div id="faq-a3" class="accordion-collapse collapse">
            <div class="accordion-body">
              Yes! You can browse all products as a guest, but you'll need to log in or register to add items to your cart, place orders, or save items to your wishlist.
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="faq-group-label" data-group="returns">
      ...
      <div class="accordion" id="accordionReturns">
        <div class="accordion-item faq-item" data-group="returns">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-r1">
              What is your return policy?
            </button>
          </h2>
          <div id="faq-r1" class="accordion-collapse collapse">
            <div class="accordion-body">
              Items may be returned within <strong>7 days</strong> of delivery, provided they are unused, in original packaging, and accompanied by proof of purchase. Certain items (perishables, digital products, undergarments) are non-returnable.
            </div>
          </div>
        </div>
        <div class="accordion-item faq-item" data-group="returns">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-r2">
              How do I get a refund?
            </button>
          </h2>
          <div id="faq-r2" class="accordion-collapse collapse">
            <div class="accordion-body">
              Once your returned item is received and inspected (3–5 business days), your refund will be processed to the original payment method within 7–10 business days.
            </div>
          </div>
        </div>
      </div>
