...
// ----------------------------------------
// GET INSTANT & CANNED CATEGORY ID
// ----------------------------------------
$catResult = mysqli_query($conn, "SELECT categoryId, name FROM categories WHERE name = 'Instant & Canned' LIMIT 1");
$category  = mysqli_fetch_assoc($catResult);
$catId     = $category['categoryId'] ?? null;
$catName   = $category['name'] ?? 'Instant & Canned';
    ...
    <form method="GET" action="" class="row g-2 align-items-center">
      <div class="col-12 col-md-5">
        <div class="input-group">
          ...
          <input type="text" name="search" class="form-control filter-bar__input"
                 placeholder="Search instant &amp; canned products…"
      ...
      <?php if ($search || $sort !== 'newest'): ?>
        <div class="col-12 col-md-2">
          <a href="instantCanned" class="btn btn-outline-secondary w-100 btn-clear-filter">
    ...
    <div class="card">
      <div class="card-body">
        <div class="empty-state">
          ...
          <a href="instantCanned" class="btn btn-primary mt-2">
            <i class="bi bi-arrow-left me-1"></i> Back to Instant &amp; Canned
          </a>
        </div>
      </div>
    </div>
          ...
          <div class="product-card">
            ...
            <div class="product-body">
              <div class="product-category">
                <?= htmlspecialchars($product['categoryName'] ?? 'Instant & Canned') ?>
              </div>
