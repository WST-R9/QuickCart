            ...
            <div class="d-flex flex-column gap-2">
              <?php foreach ($notifs as $n):
                $icon = match ($n['type']) {
                  ...
                  'order_status_updated' => 'bi-bag-check text-success',   // ✅
                  'shipping_updated' => 'bi-truck text-info',           // ✅
                  'ticket_reply' => 'bi-headset text-primary',
                  'refund_approved' => 'bi-check-circle text-success', // ✅
                  'refund_rejected' => 'bi-x-circle text-danger',      // ✅
                ...
                <a href="<?= $link ?>" class="text-decoration-none">
                  <div class="d-flex align-items-start gap-3 p-3 rounded-3 border"
                    style="background:#fff; transition:background 0.15s;" onmouseover="this.style.background='#f0faf3'"
                    ...
                    <div class="flex-grow-1">
                      ...
                      <div class="text-muted" style="font-size:11px;"><?= date('M d, Y h:i A', strtotime($n['createdAt'])) ?>
                      </div>
                    </div>
                  </div>
                </a>
