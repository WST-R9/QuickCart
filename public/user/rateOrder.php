...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submitRatings'])) {
    ...
    foreach ($items as $item) {
        ...
        if ($rating < 1 || $rating > 5) continue; // skip unrated
