      ...
      ?>
        <li>
          <a href="<?= $link ?>"
            ...
            <span style="width:8px;height:8px;border-radius:50%;background:#005d21;margin-top:6px;flex-shrink:0;"></span>
          </a>
        </li>
      <?php endforeach; ?>
      <li class="text-center py-2 border-top">
        <a href="notifications" class="small text-success text-decoration-none fw-semibold">View all notifications</a>
      </li>
    <?php endif; ?>
  </ul>
</li>
